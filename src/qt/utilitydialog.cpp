    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        licenseInfoHTML.replace(uri, "<a style=\"color:#0aebc9\" href=\"\\1\">\\1</a>");
...
These denominations are 0.001 zeroone, 0.01 ZOC, 0.1 ZOC, 1 ZOC and 10 ZOC -- sort of like the paper money you use every day.</li> \
